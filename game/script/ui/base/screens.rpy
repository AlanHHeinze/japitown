...
style window:
    ...
    ## Fondo semi-transparente oscuro (sin imagen)
    background "#1a1a1aCC"
...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("G.Rápida") action QuickSave()
...
screen about():
    ...
    use game_menu(_("Acerca de"), scroll="viewport"):
        ...
        vbox:
            ...
            label "[config.name!t]"
            text _("Versión [config.versión!t]\n")
...
style page_label_text:
    textalign 0.5
    layout "subtitle"
    hover_color gui.idle_color  # Cambiado para que no resalte
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    ...
                    label _("Velocidad texto")

                    bar value Preference("text speed")

                    label _("Avance automático")
...
## Language screen ###############################################################
##
## Permite al jugador cambiar el idioma del juego entre Español e Inglés.

screen language():

    tag menu

    use game_menu("Idioma / Language", scroll=None):
...
screen keyboard_help():
    ...
    hbox:
        label _("Espacio")
        text _("Avanza sin seleccionar opciones.")
    ...
    hbox:
        label _("Ctrl")
        text _("Salta el diálogo al mantener presionado.")

    hbox:
        label _("Tab")
        text _("Activa o desactiva el salto de diálogo.")
    ...
    hbox:
        label "S"
        text _("Toma una captura.")

    hbox:
        label "V"
        text _("Activa la {a=https://www.renpy.org/l/voicing}narración automática{/a}.")
...
screen mouse_help():
    ...
    hbox:
        label _("Click izquierdo")
        text _("Avanza el diálogo y activa la interfaz.")

    hbox:
        label _("Click central")
        text _("Oculta la interfaz.")

    hbox:
        label _("Click derecho")
        text _("Accede al menú del juego.")

    hbox:
        label _("Rueda arriba")
        text _("Retrocede al diálogo anterior.")
...
screen gamepad_help():
    ...
    hbox:
        label _("Start, Guide, Botón B/Derecho")
        text _("Accede al menú del juego.")

    hbox:
        label _("Botón Y/Arriba")
        text _("Oculta la interfaz.")
