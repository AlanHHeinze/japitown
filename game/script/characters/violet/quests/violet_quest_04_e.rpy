...
label quest_violet_questprincipal_04_e:
    ...
    show mc_parado_base b_hablando
    mc "No, esta es buena, podria encargar en la tienda un cosplay nuevo y que lo envien, si no queres usar el que tenes, podemos comprar otro"
    ...
    show violet_parada b_hablandochica
    violet "¿Y vos vas a usar algo?"
    show violet_parada b_none

    show mc_parado_base b_hablando
    mc "No lo pense, pero si te hace sentir mas comoda, puedo usar algun cosplay tambien"
    show mc_parado_base b_none
