...
## Color veraniego - Azul cielo
define gui.accent_color = '#4FC3F7'

## The color used for a text button when it is neither selected nor hovered.
## Color claro veraniego
define gui.idle_color = '#E0E0E0'

## The small color is used for small text, which needs to be brighter/darker to
## achieve the same effect.
define gui.idle_small_color = '#B0BEC5'

## The color that is used for buttons and bars that are hovered.
## Naranja atardecer para hover
define gui.hover_color = '#FFB74D'
...
define gui.insensitive_color = '#666666'

## Colors used for the portions of bars that are not filled in. These are not
## used directly, but are used when re-generating bar image files.
## Verde césped para barras
define gui.muted_color = '#2E7D32'
define gui.hover_muted_color = '#66BB6A'

## The colors used for dialogue and menu choice text.
## Beige arena para texto
...
define gui.text_font = "fonts/Roboto-Bold.ttf"

## The font used for character names.
define gui.name_text_font = "fonts/Roboto-Bold.ttf"

## The font used for out-of-game text.
define gui.interface_text_font = "fonts/Roboto-Bold.ttf"
...
## Colores veraniegos para botones
define gui.button_text_idle_color = gui.idle_color
define gui.button_text_hover_color = gui.hover_color  # Naranja atardecer al hover
...
define gui.choice_button_borders = Borders(94, 10, 94, 10)
define gui.choice_button_text_font = gui.text_font
define gui.choice_button_text_size = 21
define gui.choice_button_text_xalign = 0.5
## Colores para botones de elección
define gui.choice_button_text_idle_color = '#E0E0E0'
define gui.choice_button_text_hover_color = '#E0E0E0'  # Blanco, igual que idle
define gui.choice_button_text_insensitive_color = '#6666667f'
...
define gui.slot_button_text_selected_hover_color = gui.selected_color  # Cambiado para que no resalte
...
define config.mouse = {
    ...
    "hand": [("gui/cursor_hand.png", 0, 0)]
}

## Estilo para botones de menú con cursor de mano
style menu_choice_button is button:
    hover_sound "audio/sfx/hover.ogg"

style menu_choice_button_text is button_text:
    idle_color gui.button_text_idle_color
    hover_color gui.button_text_idle_color
    selected_color gui.button_text_selected_color
    insensitive_color gui.button_text_insensitive_color

init python:
    # Configurar cursor de mano para TODOS los botones por defecto
    style.button.mouse = "hand"
    # Configurar cursor de mano para botones de menú
    style.menu_choice_button.mouse = "hand"