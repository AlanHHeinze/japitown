...
label quest_violet_questprincipal_04_e:
    ...
    mc "No, esta es buena, podría encargar en la tienda un cosplay nuevo y que lo envien, si no quieres usar el que tienes, podemos comprar otro"
    ...
    mc "No lo pensé, pero si te hace sentir más comoda, puedo usar algún cosplay también"
    show mc_parado_base b_none c_rbase_base with sprite_fast
